    ...
    def __init__(self, hyperparameters):
        ...
        for hyperparameter in hyperparameters:
            ...
            if hyperparameter.name in self.hyperparameter_map:
                ...
                raise DuplicateHyperparameterError(
                    'Conflicting Hyperparameter: '+str(hyperparameter.name))
        ...
        if len(missing):
            raise MissingHyperparameterError(
                'Parameters: '+str(missing)+' are missing. '
    ...
    def __str__(self):
        ...
        for hyperparameter in self.hyperparameters:
            string.append(
                ...
                (str("Name:") +str(hyperparameter_name)+str(self_max_length)+ ' |'
                +"Value: "+str(hyperparameter_value)).ljust(10))
        return ''.join(string)
