...
class Log():
    ...
    def __repr__(self):
        string = []
        string.append('s_max: '+str(self.size))
        for s, log in enumerate(self.logs):
            string.append('s: '+str(s))
            for budget in log:
                string.append('Budget: '+str(budget))
                string.append('Loss: '+str(log[budget]["loss"]))
                string.append(str(log[budget]['hyperparameter']))
        string.append('Best Hyperparameter Configuration:')
        string.append('Budget: '+str(self.best["budget"]))
        string.append('Loss: '+str(self.best["loss"]))
        string.append(str(self.best['hyperparameter']))
        return '\n'.join(string)
